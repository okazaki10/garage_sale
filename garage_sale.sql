...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 16, 2019 at 01:40 PM
...
INSERT INTO `user` (`id_user`, `username`, `password`, `nama_lengkap`, `alamat`, `nomor_telpon`, `provinsi`, `kota`, `kode_pos`, `foto_profil`, `level`) VALUES
(1, 'asdfaasadasdssffss', 'asdafs', '', '', 0, '', '', 0, '', 0),
(5, 'raka', 'coeg', '', '', 0, '', '', 0, '', 0),
(6, 'avsvs', 'coeg', '', '', 0, '', '', 0, '', 0),
(7, 'avsvs', 'coeg', '', '', 0, '', '', 0, '', 0),
(8, 'avsvs', 'coeg', '', '', 0, '', '', 0, '', 0),
(9, 'avsvs', 'coeg', 'bshsvz', 'ahshz', 497377, 'aysbsyz', 'suzhzx', 4679737, '', 0),
(10, 'avsvs', 'coeg', 'bshsvz', 'ahshz', 497377, 'aysbsyz', 'suzhzx', 4679737, '', 0),
(11, 'avsvs', 'coeg', 'bshsvz', 'ahshz', 497377, 'aysbsyz', 'suzhzx', 4679737, '', 0),
(12, 'avsvs', 'coeg', 'bshsvz', 'ahshz', 497377, 'aysbsyz', 'suzhzx', 4679737, '', 0),
(13, 'avsvs', 'coeg', 'bshsvz', 'ahshz', 497377, 'aysbsyz', 'suzhzx', 4679737, '', 0),
(15, 'garok', 'coeg', 'ngentot', 'jaabh', 49434, 'ahabsz', 'ajbsz', 649748, '', 1),
(16, 'garoka', 'a', '', 'Name', 0, 'Name', 'Name', 0, '', 0),
(17, 'garokbazs', 'a', '', 'Name', 0, 'Name', 'Name', 0, '', 0),
(18, 'bshzx', 'coeg', 'hahs', '', 0, '', '', 0, '', 1);
